            ...
            <div class="container-fluid">
				 <!-- Page Heading -->              
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">ORACLE-JDBC</h1>                                        
                    </div>
                    <!-- Content Row -->
                <div class="row">            
					<!-- 내용입력 -->
					<h3>기존수업에서 마리아디비를 주로사용하였고 오라클을 배울수있는 기회가 생겨 오라클을 사용하였을때</h3> 
					<br>
					<h3>마리아디비와 차이점과 결과물을 확인하고싶어서 만들게됨</h3>
					<br>
					<h3>차이점:오라클은 탑쿼리(마리아DB limit 키워드)를 제공하지 않는다 </h3>
					<br>
					<h3>그래서 rownum이라는 오라클 의사컬럼을 사용한다 </h3>
					<br>
					<h3>rownum은 where절에서 1행조건이 들어가지 않으면 첫번째행이 false조건으로 하나도 조회되지 않는다</h3>
					<br>
				</div>
			</div>
